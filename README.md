...
This is the Beryl Website which people can run the Beryl code easily to train Neural Network.

### What is this repository for? ###

The Beryl Website. 

This website is deployed on Apache httpd 2 with python cgi module.
User should modify the configuration of apache (e.g. /etc/apache2/httpd.conf under the Unix environment) to make sure it can run on user's own computer. It differs from the differnent systems. 

It offers an example code: imdb.bl for the imdb.data.
The user can copy the imdb.bl code to the code area on the website and easily train the model.
